...
// Retrieve student ID from URL query parameter
$student_id = $_GET['student_id'];

// Fetch data for the specified student
$sql = "SELECT * FROM admin_student_course WHERE student_id = '$student_id'";
$result = $conn->query($sql);

// Your HTML and PHP code to display the details for the specified student
?>
